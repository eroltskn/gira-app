...
from controller.issue.issue_get import issue_get_endpoint
...
from controller.project.project_get import project_get_endpoint
...
def bind_endpoints():
    ...
    current_app.register_blueprint(issue_get_endpoint, url_prefix='/v1/')
    ...
    current_app.register_blueprint(project_get_endpoint, url_prefix='/v1/')
